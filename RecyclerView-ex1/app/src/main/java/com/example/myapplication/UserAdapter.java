...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder>{
    ...
    // 7번 getView랑 똑같음
    // 차이점이 있다면 ListView는 화면에 3개가 필요하면
    // 최초 로딩시에 3개를 그려야하니까 View가 3번 호출됨
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view); // view 가 리스트 뷰에 하나 그려짐
    }
    ...
    // 6번 컬렉현 크기 알려주기 (화면에 몇개 그려야 될지를 알아야 하기 때문)
    @Override
